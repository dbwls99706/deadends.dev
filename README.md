...
|----------|-------------|
| [`/api/v1/match.json`](https://deadend.dev/api/v1/match.json) | Lightweight regex matching (fits in context window) |
| [`/api/v1/index.json`](https://deadend.dev/api/v1/index.json) | Full error index with all metadata |
| `/api/v1/{domain}/{slug}/{env}.json` | Individual error canon |
| [`/api/v1/openapi.json`](https://deadend.dev/api/v1/openapi.json) | OpenAPI 3.1 spec |
| [`/llms.txt`](https://deadend.dev/llms.txt) | LLM-optimized error listing ([llmstxt.org](https://llmstxt.org) standard) |
| [`/llms-full.txt`](https://deadend.dev/llms-full.txt) | Complete database dump |
| [`/.well-known/ai-plugin.json`](https://deadend.dev/.well-known/ai-plugin.json) | AI plugin manifest |
